      ...
      this.$alert('确定修改个人信息？', '提示', {
          ...
          callback: action => {
            let user={
              ...
              userAddress: this.infoform.user_address,
              userBirth: this.infoform.user_birth,
              userMarry: this.infoform.user_marry,
              userNickname: this.infoform.user_nickname,
              userPosition: this.infoform.user_positon,
              userProfilePhoto: null,
              userSex: this.infoform.user_sex,
              userSignature: this.infoform.user_signature,
              userTown: this.infoform.user_town,
              userUnit: this.infoform.user_unit
            }
