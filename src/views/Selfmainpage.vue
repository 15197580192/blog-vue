      ...
      <div id="centerleft" style="width: 40%;float: left;margin-top: 10px">
        ...
        <div>
          <ul style="float: left;list-style-type: none;margin-left: 10%">
            ...
            <li style="margin-top: 5px"><h4 @click="this.gozl">我的专栏</h4></li>
            <li style="margin-top: 5px"><h4 @click="this.gocol">我的收藏</h4></li>
            <li style="margin-top: 5px"><h4 @click="this.gogz">我的关注</h4></li>
            <li style="margin-top: 5px"><h4 @click="this.gomyblog">我的博客</h4></li>
            <li style="margin-top: 5px"><h4 @click="this.gocount">账户中心</h4></li>
          </ul>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    gomyblog () {
      this.$router.replace('/myblogs/'+this.userId)
    },
    gocount () {
